...
// Initializes the Alapca provider.
void Alapca::Initialize()
{
    std::cout << "Alapca initialized" << std::endl;
...
size_t Alapca::WriteCallback(void *contents, size_t size, size_t nmemb, std::string *userp)
{
...
std::string Alapca::UrlEncode(const std::string &value)
{
...
std::string Alapca::FormatRFC3339(const std::string &dateStr)
{
...
std::string Alapca::MakeApiRequest(const std::string &url)
{
    CURL *curl;
    CURLcode res;
...
std::vector<Bar> Alapca::Get_Historical_Bars(const std::string &symbols, const std::string &timeframe, const std::string &start, const std::string &end)
{
...
// Output: Bar object.
Bar Alapca::Get_Latest_Bars(const std::string &symbols)
{
    std::ostringstream url;
...
std::vector<Quote> Alapca::Get_Historical_Quotes(const std::string &symbols, const std::string &start, const std::string &end)
{
    std::ostringstream url;
...
// Output: Quote object.
Quote Alapca::Get_Latest_Quotes(const std::string &symbols)
{
    std::ostringstream url;
...
std::vector<Trade> Alapca::Get_Historical_Trades(const std::string &symbols, const std::string &start, const std::string &end)
{
    std::ostringstream url;
...
// Output: Trade object.
Trade Alapca::Get_Latest_Trades(const std::string &symbols)
{
    std::ostringstream url;
...
void Alapca::Publish(const std::string &data, const std::string &info)
{
